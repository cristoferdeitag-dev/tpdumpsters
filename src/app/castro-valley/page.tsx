...
const castroValleyFaqs = [
  ...
  },
  {
    ...
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        For typical Castro Valley home remodels — kitchen and bath renovations, flooring replacement, or room additions — a <strong>20-yard dumpster ($699)</strong> is the most popular choice. For larger projects like whole-home renovations or multi-room tear-outs, the 30-yard at $799 gives you plenty of room.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        Castro Valley dumpster rental prices start at <strong>$599 for a 10-yard</strong> dumpster (7-day rental, 1 ton included). The 20-yard starts at $699 and the 30-yard at $799. No hidden fees, no surprise charges. Call <strong>(510) 650-2083</strong> for an exact quote for your Castro Valley project.
      </p>
    ),
  },
];
...
export default function CastroValleyPage() {
  return (
    <>
      ...
      <PricingTable cityName="Castro Valley" />
      <SizesSection />
