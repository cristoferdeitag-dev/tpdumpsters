...
function generateResponse(message: string, language: string): string {
  ...
  if (msg.includes("extra day") || msg.includes("additional day") || msg.includes("keep longer") || msg.includes("extend") || msg.includes("día extra") || msg.includes("dia extra") || msg.includes("más días") || msg.includes("mas dias") || msg.includes("extender")) {
    return es
      ? "📅 **Tarifa por día extra:** **$49/día**\n\nSi necesitas el dumpster más tiempo del periodo incluido (3 días para 10 yard, 7 días para 20/30 yard de General Debris, 3 días para materiales pesados), simplemente llámanos al **(510) 650-2083** para extender.\n\nNo hay límite de extensión — solo $49 por cada día adicional."
      : "📅 **Extra day fee:** **$49/day**\n\nIf you need the dumpster longer than the included period (3 days for 10 yard, 7 days for 20/30 yard General Debris, 3 days for heavy materials), just call us at **(510) 650-2083** to extend.\n\nNo extension limit — just $49 per additional day.";
  }
  ...
  if (msg.includes("overweight") || msg.includes("over weight") || msg.includes("too heavy") || msg.includes("weight limit") || msg.includes("sobrepeso") || msg.includes("peso") || msg.includes("tonelada") || msg.includes("ton limit")) {
    return es
      ? "⚖️ **Tarifa por sobrepeso:** **$179/ton prorrateado**\n\n**Peso incluido por tamaño:**\n• 10 yard: 1 ton\n• 20 yard: 2 tons\n• 30 yard: 3 tons\n\nSi excedes el peso incluido, se cobra $179 por cada tonelada adicional (prorrateado). Los materiales pesados como tierra y concreto tienen peso ilimitado en sus paquetes especiales.\n\n¿Preguntas? **(510) 650-2083**"
      : "⚖️ **Overweight fee:** **$179/ton prorated**\n\n**Included weight by size:**\n• 10 yard: 1 ton\n• 20 yard: 2 tons\n• 30 yard: 3 tons\n\nIf you exceed the included weight, it's $179 per additional ton (prorated). Heavy materials like soil and concrete have unlimited weight in their special packages.\n\nQuestions? **(510) 650-2083**";
  }
  ...
  if (msg.includes("price") || msg.includes("cost") || msg.includes("how much") || msg.includes("precio") || msg.includes("costo") || msg.includes("cuánto") || msg.includes("cuanto")) {
    return es
      ? `💰 **Precios de TP Dumpsters:**\n\n🟢 **General Debris** (construcción, demolición)\n• 10 yard: $599 (3 días, 1 ton incluida)\n• 20 yard: $649 (7 días, 2 tons incluidas)\n• 30 yard: $749 (7 días, 3 tons incluidas)\n\n🟤 **Materiales Pesados** (10 yard, 3 días)\n• Clean Soil: $599 (sin límite de peso)\n• Clean Concrete: $599 (95% puro, sin varilla)\n• Mixed Materials: $899 (mezcla tierra/concreto)\n\n📌 **Extras:**\n• Días extra: $49/día\n• Sobrepeso: $179/ton prorrateado\n\n🎉 **¡Reserva en línea y obtén $50 de descuento!**\n\n[Reserva aquí](https://tpdumpsters.com/booking) o llámanos: **(510) 650-2083**`
      : `💰 **TP Dumpsters Pricing:**\n\n🟢 **General Debris** (construction, demolition)\n• 10 yard: $599 (3 days, 1 ton included)\n• 20 yard: $649 (7 days, 2 tons included)\n• 30 yard: $749 (7 days, 3 tons included)\n\n🟤 **Heavy Materials** (10 yard, 3 days)\n• Clean Soil: $599 (no weight limit)\n• Clean Concrete: $599 (95% pure, no rebar)\n• Mixed Materials: $899 (soil & concrete mix)\n\n📌 **Extras:**\n• Extra days: $49/day\n• Overweight: $179/ton prorated\n\n🎉 **Book online and get $50 off!**\n\n[Book here](https://tpdumpsters.com/booking) or call us: **(510) 650-2083**`;
  }
