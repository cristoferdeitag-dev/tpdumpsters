...
const cities = ["oakland", "pinole", "richmond", "concord", "berkeley", "hayward", "fremont", "walnut-creek", "alameda", "antioch", "san-leandro", "vallejo", "livermore", "lafayette", "pleasanton", "san-ramon", "dublin", "brentwood", "union-city", "newark", "pleasant-hill", "martinez", "pittsburg", "castro-valley", "hercules", "el-cerrito", "danville", "benicia", "oakley", "san-pablo", "orinda", "moraga", "bay-point", "american-canyon", "el-sobrante", "san-francisco", "san-rafael", "novato", "mill-valley", "sausalito", "tiburon", "corte-madera", "larkspur", "san-anselmo", "clayton", "rodeo", "crockett", "contra-costa-county", "marin-county", "fairfield", "san-lorenzo", "emeryville", "piedmont", "alameda-county", "vacaville", "suisun-city", "solano-county", "daly-city", "redwood-city", "san-mateo", "south-san-francisco", "pacifica", "burlingame", "san-bruno", "foster-city", "belmont", "san-carlos", "millbrae", "san-mateo-county", "santa-clara", "milpitas", "santa-clara-county"];
