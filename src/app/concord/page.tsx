...
const concordFaqs = [
  {
    ...
    answer: (
      <p className="text-sm text-[#666] leading-[1.7] mb-2.5">
        Dumpster rental in Concord starts at <strong>$599 for a 10-yard</strong> (3-day rental, 1 ton
        included), $649 for a 20-yard (2 tons), and $749 for a 30-yard (3 tons). We offer transparent
